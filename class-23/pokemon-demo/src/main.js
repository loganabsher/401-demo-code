  ...
  render(){
    return(
      <form onSubmit={this.handleSubmit}>
        <input type='text' name='pokemonName' placeholder='search for a pokemon' value={this.state.pokeName} onChange={this.handlePokemonNameChange} />
      </form>
    )
  }
}
      ...
      <section>
        ...
        {this.state.pokemonNameError ?
          ...
          {this.state.pokemonSelected ?
            ...
            <div>
              <p>Please make a request to get data</p>
            </div>
          }
          </div>
        }
